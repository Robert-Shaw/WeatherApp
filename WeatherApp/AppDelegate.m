...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CityNamesViewControllerTableViewController *controller = [[CityNamesViewControllerTableViewController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.glucode.corp.WeatherApp" in the application's documents directory.
